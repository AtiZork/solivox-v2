...
document.getElementById("editTransactionForm").addEventListener("submit", async function (event) {
    ...
    if (editingIsSniper) {
        requestData = {
            ...
            drop_cutoff_enabled: !!document.getElementById("updateDropCutoffEnabled")?.checked,
...
function openEditModal(value) {
    ...
    if (editingIsSniper) {
        ...
        document.getElementById("updateDropCutoffEnabled").checked = transaction.drop_cutoff_enabled !== false;
